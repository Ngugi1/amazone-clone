  ...
  render() { 
    return (<div className="drink_item">
      ...
      <div className="drink_item_price_percentage">
        <span className="drink_item_price">Ksh. 250</span>
      </div>
      <label className="drink_item_title">Chrome Gin</label>
      <div className="drink_item_location">
        <FontAwesomeIcon icon={faMapMarkerAlt} color="green" />
        <label className="drink_item_ws_name">Butlers Wines and Spirits (2km)</label>
      </div>
      <div className="drink_item_deliverly">
        <button className="drink_item_order">
          <FontAwesomeIcon icon={faShippingFast} />
          <span className="drink_item_button_span">Call for delivery</span>
        </button>
      </div>
    </div>);
  }
